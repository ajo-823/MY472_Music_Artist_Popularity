...
1. The Rolling Stone's 100 Greatest Artists (RS100) article, which I accessed by scraping the website to get artist name, rank, and description. No data manipulation was needed after collection. All 3 variables were stored in a single table.
...
This histogram shows the distribution of Spotify artist popularity scores. The scores are between 0 (lowest) and 100 (highest). The chart indicates that the scores are not uniquely high, with the majority being between 53 and 83.
...
The table below shows the top 10 artists for Spotify popularity. These artists all have popular top songs, rock genres, millions in certified sales (units), and all from the US, UK, or Australia. What explains why these artists are popular compared to others from the RS100?
